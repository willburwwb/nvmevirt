...
struct nvmev_io_worker_profile {
	...
	unsigned long long fast_read_hits;
	unsigned long long slow_path_calls;
	unsigned long long single_prp_reads;
	unsigned long long multi_prp_ios;
	unsigned long long prp_map_calls;
	unsigned long long prp_map_ns;
	unsigned long long prp_list_calls;
	unsigned long long prp_list_ns;
	unsigned long long io_copy_calls;
	unsigned long long io_copy_ns;
	unsigned long long latency_samples;
	unsigned long long queue_wait_ns;
	unsigned long long post_copy_wait_ns;
	unsigned long long total_device_ns;
